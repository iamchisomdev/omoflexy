...
const Recommendation = ({ currentCategory, currentProductId }) => {
  ...
  if (loading) {
    return <div className="px-4 md:px-16 inter text-[20px] py-8">Loading products...</div>;
  }
  ...
  if (!products.length) {
    return <div className="px-4 md:px-16 py-8 inter text-[22px]">No recommended products</div>;
  }
